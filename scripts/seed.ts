...
async function main() {
  ...
  const products = [
    ...
    },
    {
      ...
      category: 'SAAS',
      price: 129,
      fileUrl: 'https://placeholder.supabase.co/storage/v1/object/public/product-files/saas-starter.zip',
    ...
    },
    {
      ...
      category: 'APIS',
      price: 39,
      fileUrl: 'https://placeholder.supabase.co/storage/v1/object/public/product-files/ts-api-utils.zip',
    ...
    },
    {
      ...
      category: 'REACT',
      price: 69,
      fileUrl: 'https://placeholder.supabase.co/storage/v1/object/public/product-files/react-lib.zip',
